...
class ArticleViewModel {
  static List<Article> allArticles = [
    Article(
      ...
      content:
          "This article discusses recent advancements in the field of cardiology, including breakthroughs in the treatment of heart diseases and innovative diagnostic techniques.",
